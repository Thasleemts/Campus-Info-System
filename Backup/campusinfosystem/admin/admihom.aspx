   ...
   <div class="full" id="dash1">
		...
		<div class="content">
          ...
          Alumin Requsets<br/><br/><br/></a></div>
           ...
           <div class="grid4" style="background-color:#44b6ae"><br/><font>Update</font><br/>Course Details<br/><br/><br/></div>

            <div class="grid4" style="background-color:#8775a7"><br/>
            <a href="Gallery.aspx"><font>Create</font><br/>
            Gallery<br/><br/><br/></a></div>

       	  <div class="grid4" style="background-color:#578ebe"><br/><font>Create</font><br/>
       	  Notice Board<br/><br/><br/></div>
          ...
          <div class="grid4" style="background-color:#44b6ae"><br/>
          <font>Update</font><br/>
          Batch Details<br/><br/><br/></div>

            <div class="grid4" style="background-color:#8775a7"><br/><font>Update</font><br/>
            Branch Details<br/><br/><br/></div>
