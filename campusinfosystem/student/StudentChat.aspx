<%@ Page Title="" Language="C#" MasterPageFile="~/student/studentpage.Master" AutoEventWireup="true" CodeBehind="StudentChat.aspx.cs" Inherits="campusinfosystem.student.StudentChat" %>
        ...
        <tr>
            ...
            <asp:DropDownList ID="drponline" runat="server" 
                ...
                DataValueField="Username" AutoPostBack="True" 
                    ...
                    ondatabound="drponline_DataBound" Height="43px" Width="168px">
            </asp:DropDownList>
