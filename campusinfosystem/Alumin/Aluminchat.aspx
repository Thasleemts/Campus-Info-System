<%@ Page Title="" Language="C#" MasterPageFile="~/Alumin/AluminMaster.Master" AutoEventWireup="true" CodeBehind="Aluminchat.aspx.cs" Inherits="campusinfosystem.Alumin.Aluminchat" %>
        ...
        <tr>
            ...
            <asp:DropDownList ID="drponline" runat="server" 
                ...
                DataValueField="Username" AutoPostBack="True" 
                    ...
                    ondatabound="drponline_DataBound" Height="47px" Width="168px">
            </asp:DropDownList>
